...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default='shop-image.jpg', null=True, upload_to='vendor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payout_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=6, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('PayPal', 'PayPal'), ('Stripe', 'Stripe'), ('Bank Transfer', 'Bank Transfer'), ('Uzbekistan Bank Account', 'Uzbekistan Bank Account'), ('Korean Bank Account', 'Korean Bank Account'), ('Western Union', 'Western Union'), ('American Express', 'American Express')], max_length=100, null=True)),
