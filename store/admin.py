...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['name', 'image', 'description', 'category', 'price', 'regular_price']
...
class GalleryAdmin(admin.ModelAdmin):
    list_display = ['product', 'galley_id']
    search_fields = ['product__name', 'galley_id']

class CartAdmin(admin.ModelAdmin):
    list_display = ['id', 'product', 'user', 'qty', 'price', 'total', 'date']
