    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, choices=[('Stripe', 'Stripe'), ('PayPal', 'PayPal'), ('Flutterwave', 'Flutterwave'), ('Paystack', 'Paystack')], default=None, max_length=100, null=True)),
                ...
                ('initial_total', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Grand Total of all amount', max_digits=12, null=True)),
                ('saved', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Amount to be saved', max_digits=12, null=True)),
                ...
                ('coupons', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.coupon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.CharField(choices=[('Pending', 'Pending'), ('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Fulfilled', 'Fulfilled'), ('Cancelled', 'Cancelled')], default='Pending', max_length=100)),
                ('shipping_service', models.CharField(blank=True, choices=[('Fedex', 'Fedex'), ('UPS', 'UPS'), ('DHL', 'DHL'), ('Amazon', 'Amazon'), ('Other', 'Other')], default=None, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('galley_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=10, prefix='')),
