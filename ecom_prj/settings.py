...
SECRET_KEY = 'django-insecure-67026%8g*#(64f_=e!!gdlfz5wecyc@*dcja&c#fsng6ickbn9'
...
#             'alignment', 'blockQuote', 'undo', 'redo', '|',
#             'insertTable', 'mediaEmbed', 'code', '|',
#             'removeFormat'
#         ],
#         'heading': {
#             'options': [
...
# If you use file uploading via CKEditor, add the upload path:
